...
)(
    {
        ...
        153720: e => {
            ...
            function x(e, t) {
                ...
                , r = new p;
                N(e.digits, 0, r.digits, n, r.digits.length - n);
            ...
            function R(e, t) {
                var n = Math.floor(t / o)
                , r = new p;
                N(e.digits, n, r.digits, 0, e.digits.length - n);
            ...
            function k(e, t) {
                var n = new p;
                return N(e.digits, 0, n.digits, t, n.digits.length - t),
                n
            }
            function L(e, t) {
                var n = new p;
                return N(e.digits, t, n.digits, 0, n.digits.length - t),
                n
            }
            function F(e, t) {
                var n = new p;
                return N(e.digits, 0, n.digits, 0, t),
                n
            }
            function H(e, t) {
                if (e.isNeg != t.isNeg)
            ...
            function U(e, t) {
                ...
                for (var b = v; b > m; --b) {
                    ...
                    for (var N = n.digits[b - m - 1] * (C * s + I), M = _ * u + (E * s + S); N > M; )
                        --n.digits[b - m - 1],
                        N = n.digits[b - m - 1] * (C * s | I),
                        M = _ * s * s + (E * s + S);
...
function get_pwd(data){
    ...
    return a.default.encryptedString(u, encodeURIComponent(data)) ;
}
